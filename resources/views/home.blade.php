...
@section('content')
<div class="jumbotron text-light" style="background-image: url('/images/bg-booking.jpg');background-size:100% auto;">
    <div class="container">
        @if(Auth::user()) 
        ...
        @else
        <h1 class="display-3">Remote hotel booking on Angular/Laravel.</h1>
        ...
        <a href="/login" class="btn btn-success btn-lg my-2">Log in for Booking</a>
        @endif                
    </div>
</div>
